    ...
    <>
      <div className="relative min-h-screen text-white  overflow-hidden bg-[#00080A] font-creato">
        ...
        <div className="bg-transparent " style={{ padding: "40px 50px" }}>
          ...
          <div className="grid grid-cols-7 gap-y-4 relative z-10 m-10 text-[25px]">
    ...
    <div className="md:flex sm:flex xl:flex-row justify-between font-creato ">
      <div className="flex flex-wrap justify-between items-start px-4 md:px-10 py-10 gap-10">
        ...
        <div className=" md:w-[60%] lg:w-[50%] flex gap-6">
          {/* Rotated Text */}
          <div className="hidden lg:flex flex-col items-center justify-center gap-24 mb-2">
            <div className="w-[165px] h-[2px] bg-white rotate-90" />
            <div
          ...
          <div className="flex flex-col space-y-10">
            <div className=" ml-8 mb-8 font-creato mt-12">
              <h2 className="text-3xl md:text-4xl lg:text-[50px]  text-green-400 mb-12 font-black italic">
                WHO WE ARE
              </h2>

              <div className="font-normal">
                <p className="text-white leading-relaxed text-[20px] md:text-base max-w-[695px] mt-4 font-normal">
            ...
            {/* Bottom CTA */}
            <div className="flex items-center gap-4 mt-4 md:ml-[-60px] lg:ml-[-80px]">
